        ...
        <div className='flex flex-col w-full h-[657px] py-[40px] px-20 text-black gap-10'>
            <div className='flex flex-col gap-2'>
                <div className='flex justify-between items-center'>
                    <div>
                        <h1 className='text-2xl font-semibold'>Staf & Dosen</h1>
                        <h1 className='text-sm'>Berita terkini mengenai aktivitas, kegiatan, dan riset staf dan dosen</h1>
                    </div>
                </div>
            ...
            <div className="w-full h-[478px] grid grid-cols-4 grid-flow-row gap-10">
                {activityList.map((activity, index) => (
                    <a key={index} className="cursor-pointer h-[219px] flex flex-col gap-[10px] group">
                        ...
                        <div className="flex flex-col h-[69px] gap-[10px]">
                            <h1 className="font-semibold leading-[19px] text-ellipsis overflow-hidden line-clamp-2 group-hover:text-bluesky">{activity.title}</h1>
...
export default StafAndDosenSection
