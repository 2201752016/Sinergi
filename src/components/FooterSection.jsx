            ...
            <div className='flex justify-between items-center'>
                <div className='flex w-2/3 flex-col gap-3'>
                    ...
                    <div className='flex gap-5 text-xl text-bluesky'>
                        <button><i className="fa-brands fa-facebook-f hover:text-blue"></i></button>
                        <button><i className="fa-brands fa-twitter hover:text-blue"></i></button>
                        <button><i className="fa-brands fa-square-instagram hover:text-blue"></i></button>
                        <button><i className="fa-brands fa-youtube hover:text-blue"></i></button>
                    </div>
                </div>
