        ...
        <div className='flex flex-col w-full h-[657px] py-[40px] px-20 text-black gap-10'>
            <div className='flex flex-col gap-2'>
                <div className='flex justify-between items-center'>
                    <div>
                        <h1 className='text-2xl font-semibold'>Mitra & Pers</h1>
                        <h1 className='text-sm'>Berita terkini mengenai mitra & pers kampus</h1>
                    </div>
                </div>
...
export default MitraAndPersSection
